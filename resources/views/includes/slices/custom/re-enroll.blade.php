...
<form id="reenroll" class="form" action="https://info.csuglobal.edu/l/109362/2021-02-22/91dxfs" method="POST">
    <input type="hidden" name="oid" value="00DA0000000Jdty">
    <input type="hidden" name="lead_source" id="lead_source" value="web_reenroll">

    <p id="reenroll-message" class="clr msg">* All Fields Required</p>
